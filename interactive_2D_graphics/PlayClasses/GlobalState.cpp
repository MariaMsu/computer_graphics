...
//std::shared_ptr<BackgroundMap> readBackgroundMap(const std::string& background_map_path){
//
...
//        this->background_map_vector.push_back(readBackgroundMap(background_map_path));
